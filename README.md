...
``` console
$ curl -u 00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000 localhost:9999/uaa/oauth/token -d grant_type=password -d username=maki@example.com -d password=demo
...
```
http --form --auth 00000000-0000-0000-0000-000000000001:00000000-0000-0000-0000-000000000001 localhost:9999/uaa/oauth/token grant_type=password username=maki@example.com password=demo
```
